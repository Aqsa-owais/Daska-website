export default function AssessmentsPage() {
  ...
  const handleQuiz1 = () => {
    window.open('https://docs.google.com/forms/d/e/1FAIpQLSen5BmZvVx1mI7IY1YOrXQLPFmWyllo9x5BUG6d7FJctevDBw/viewform', '_blank')
  }
  ...
  const handleQuiz5 = () => {
    window.open('https://docs.google.com/forms/d/e/1FAIpQLSf6vIekYkTh-xrwlHwVhJYyfgFhf12mul9Y1Krh7CBDGN7u_g/viewform', '_blank')
  }

  // Quiz 6 - Add your link here
  const handleQuiz6 = () => {
    window.open('https://docs.google.com/forms/d/e/1FAIpQLSeXuw2uagtDyQ08lIy-4UcknrMYHiqGBQhHbIfbRVQSw4TGuA/viewform?pli=1', '_blank')
  }
